...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('templates/dashboard/assets/img/apple-icon.png') }}">
    <link rel="icon" type="image/png" href="{{ asset('templates/dashboard/assets/img/favicon.png') }}">
    <title>
